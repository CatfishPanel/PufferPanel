...
var serverConfig = Configuration.get('server', { port: 3000 });
var yarConfig = Configuration.get('yar', { password: 'default' });
var Server = {};
                ...
                html: {
                    compile: function (template, options, next) {
                        ...
                        SettingsController.getAllSettings(function (err, result) {
                            ...
                            //TODO: This if never will work right for the env stuff, is overridden
                            if (err) {
